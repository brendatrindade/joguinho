...
#define LARGURA 640 // Largura do labirinto (deve ser ímpar)
#define ALTURA 480  // Altura do labirinto (deve ser ímpar)
...
int main() {
    ...
    imprimeLabirintoVGA(); //para apagar é so chamar apagaLabirintoVGA
